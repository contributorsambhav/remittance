        ...
        <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-primary">{hasBalanceError ? 'Error loading' : `${balanceFormatted} ETH`}</p>
            </div>
            <ConfirmationModal
              trigger={
                <Button disabled={isLoading || !canClaim} className="min-w-[120px]">
                  {isLoading ? (
                    <>
              ...
              description={
                <div className="space-y-2">
                  <p>
                    Are you sure you want to claim <strong>{balanceFormatted} ETH</strong>?
                  </p>
