    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            {isLoading || loadingBalance ? <Skeleton className="h-8 w-24" /> : hasErrorBalance ? <div className="text-sm text-red-500">Error loading balance</div> : <div className="text-2xl font-bold">{parseFloat(stats.contractBalance).toFixed(4)} ETH</div>}
